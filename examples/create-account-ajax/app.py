...
from starlite.responses import JSONResponse
from starlite.templating import Jinja2Templates
from starlite_wtf import StarliteForm, CSRFProtectMiddleware, csrf_protect, csrf_token
...
async def create_account(request):
    ...
    json = {"status": "error", "errors": form.errors}
